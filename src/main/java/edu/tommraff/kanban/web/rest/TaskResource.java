...
import edu.tommraff.kanban.service.TaskQueryService;
import edu.tommraff.kanban.service.TaskService;
...
/**
 * REST controller for managing {@link edu.tommraff.kanban.domain.Task}.
 */
@RestController
@RequestMapping("/api")
