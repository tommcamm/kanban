...
export default class Klist extends Vue {
  ...
  public prepareRemove(instance: IKlist): void {
  ...
  public removeKlist(): void {
    this.klistService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A Klist is deleted with identifier ' + this.removeId;
